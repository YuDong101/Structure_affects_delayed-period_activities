...
for iii  = 1:Nt
    ...
    if iii>=round(5*1000/step) && iii<= round(5.5*1000/step)
        IextS = I0_S;
    end
...
%% Determine whether there is spontaneous firing
